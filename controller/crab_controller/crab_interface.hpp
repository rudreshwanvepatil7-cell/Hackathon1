...
class CrabSensorData {
 public:
  CrabSensorData()
      : imu_frame_quat_(0, 0, 0, 1),
        imu_ang_vel_(Eigen::Vector3d::Zero()),
        ...
        b_FL_foot_contact_(false),
        b_FR_foot_contact_(false),
        b_RL_foot_contact_(false),
        b_RR_foot_contact_(false),
        FL_normal_force_(0.),
        FR_normal_force_(0.),
        RL_normal_force_(0.),
        RR_normal_force_(0.),
