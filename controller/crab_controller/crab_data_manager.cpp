...
CrabDataManager *CrabDataManager::GetDataManager() {
  static CrabDataManager dm;
  return &dm;
}

CrabDataManager::CrabDataManager() {
  // crab data initialize
  data_ = std::make_unique<CrabData>();
...
bool CrabDataManager::IsInitialized() { return b_initialize_socket_; }

void CrabDataManager::InitializeSocket(const std::string &ip_address) {
  socket_->bind(ip_address);
  b_initialize_socket_ = true;
}

void CrabDataManager::SendData() {
