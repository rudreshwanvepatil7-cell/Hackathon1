...
#include "controller/g1_controller/g1_crbi/g1_crbi_helper.h"
#include "controller/models/composite_rigid_body_inertia.hpp"

class G1CompositeRigidBodyInertia : public CompositeRigidBodyInertia {
public:
  G1CompositeRigidBodyInertia();
  virtual ~G1CompositeRigidBodyInertia();
