...
class crab_joint_idx(object):
    base_joint = 0
    top_lidar_base_joint = 1
    bottom_lidar_base_joint = 2
    base_link_back__sensor_joint = 3
    base_link_left__sensor_joint = 4
    base_link_right__sensor_joint = 5
    base_link_front_right__sensor_joint = 6
    base_link_front_left__sensor_joint = 7
    base_link_front_right__joint = 8
    front_right__cluster_1_base_fix = 9
    front_right__cluster_1_roll = 10
    front_right__cluster_1_pitch = 11
    front_right__cluster_1_end_joint = 12
    front_right__cluster_2_base_fix = 13
    front_right__cluster_2_roll = 14
    front_right__cluster_2_pitch = 15
    front_right__cluster_2_end_joint = 16
    front_right__cluster_3_base_fix = 17
    front_right__cluster_3_roll = 18
    front_right__cluster_3_pitch = 19
    front_right__cluster_3_mid_joint = 20
    front_right__cluster_3_wrist = 21
    front_right__cluster_3_end_joint = 22
    front_right__cluster_3_wrist_link_foot_joint = 23
    base_link_front_left__joint = 24
    front_left__cluster_1_base_fix = 25
    front_left__cluster_1_roll = 26
    front_left__cluster_1_pitch = 27
    front_left__cluster_1_end_joint = 28
    front_left__cluster_2_base_fix = 29
    front_left__cluster_2_roll = 30
    front_left__cluster_2_pitch = 31
    front_left__cluster_2_end_joint = 32
    front_left__cluster_3_base_fix = 33
    front_left__cluster_3_roll = 34
    front_left__cluster_3_pitch = 35
    front_left__cluster_3_mid_joint = 36
    front_left__cluster_3_wrist = 37
    front_left__cluster_3_end_joint = 38
    front_left__cluster_3_wrist_link_foot_joint = 39
    base_link_back_right__joint = 40
    back_right__cluster_1_base_fix = 41
    back_right__cluster_1_roll = 42
    back_right__cluster_1_pitch = 43
    back_right__cluster_1_end_joint = 44
    back_right__cluster_2_base_fix = 45
    back_right__cluster_2_roll = 46
    back_right__cluster_2_pitch = 47
    back_right__cluster_2_end_joint = 48
    back_right__cluster_3_base_fix = 49
    back_right__cluster_3_roll = 50
    back_right__cluster_3_pitch = 51
    back_right__cluster_3_mid_joint = 52
    back_right__cluster_3_wrist = 53
    back_right__cluster_3_end_joint = 54
    back_right__cluster_3_wrist_link_foot_joint = 55
    base_link_back_left__joint = 56
    back_left__cluster_1_base_fix = 57
    back_left__cluster_1_roll = 58
    back_left__cluster_1_pitch = 59
    back_left__cluster_1_end_joint = 60
    back_left__cluster_2_base_fix = 61
    back_left__cluster_2_roll = 62
    back_left__cluster_2_pitch = 63
    back_left__cluster_2_end_joint = 64
    back_left__cluster_3_base_fix = 65
    back_left__cluster_3_roll = 66
    back_left__cluster_3_pitch = 67
    back_left__cluster_3_mid_joint = 68
    back_left__cluster_3_wrist = 69
    back_left__cluster_3_end_joint = 70
    back_left__cluster_3_wrist_link_foot_joint = 71
